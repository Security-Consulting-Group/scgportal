...
# uwsgi --http :8000 --module core.wsgi:application --env DJANGO_SETTINGS_MODULE=core.settings.production --master --workers 4 --enable-threads --socket /tmp/uwsgi.sock --chmod-socket=664 --vacuum --die-on-term --thunder-lock